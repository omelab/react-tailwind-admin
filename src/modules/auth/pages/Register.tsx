...
const registerSchema = object({
  ...
  username: string().min(1, 'Email address is required').email('Email Address is invalid'),
  password: string()
  ...
  return (
    <div className='flex justify-center'>
      <div className='w-full max-w-xs'>
        ...
        <p className='text-center text-gray-500 text-xs'>&copy;2020 All rights reserved.</p>
      </div>
    </div>
  );
};
